...
-   +20% DMG
-   +30% CRIT DMG
-   +900 Sheer Force (at 24000 initial Max HP)
-   +5% Max HP (Ether Veil)
-   +18% DMG (Moonlight Lullaby 4PC)
-   +25% DMG (Dreamlit Hearth S1)
-   +15% Max HP (Dreamlit Hearth S1)
-   Ultimate heals
...
-   Perfect Assists when entering the the Dream State (bar fills up)

Core Skill Additional Ability (Rupture, Stun):

-   +30% CRIT DMG from Darkbreaker (using Harmony)
...
-   Dreamlit Hearth: Signature S-Rank. +30% initial Max HP. +15% HP, +25% DMG.
-   Kaboom the Canon: Energy Regen main stat, ATK% effect

Disk Drives:

-   4PC Moonlight Lullaby: +18% DMG for team
-   2PC Yunkui Tales: +10% initial Max HP for herself
-   2PC Shining Aria: +10% Ether DMG for herself
